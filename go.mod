module github.com/graphaelli/metricize

go 1.18

require (
	github.com/cespare/xxhash/v2 v2.2.0
	github.com/elastic/apm-server v0.0.0-20221206053257-631667a92e96
...
replace github.com/elastic/apm-server/internal/approvaltest => ./
